...
const questionAnswerableIds = [process.env.COACH, process.env.DFZ_ADMIN];
...
commandForName['ask'] = {
  execute: async (msg, args) => {
    ...
    //TODO guild id
    const guild = await client.guilds.get('631605827337191424');
    ...
    //TODO qa channel id
    const qaChannel = await client.channels.get('732360148743356436');
